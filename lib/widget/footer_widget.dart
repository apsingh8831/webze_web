...
class WebFooterWidget extends StatefulWidget {
  ...
  @override
  State<WebFooterWidget> createState() => _WebFooterWidgetState();
}

class _WebFooterWidgetState extends State<WebFooterWidget> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(begin: AlignmentGeometry.topCenter,end: AlignmentGeometry.bottomCenter,colors: [Colors.white10,Colors.black45])
      ),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: BuiltWidget(text: 'BUILT WEB3, POWERED BY YOU',fontSize: 13,)),
