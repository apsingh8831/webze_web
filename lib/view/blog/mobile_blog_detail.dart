...
class MobileBlogDetail extends StatefulWidget {
  const MobileBlogDetail({super.key});

  @override
  State<MobileBlogDetail> createState() => _MobileBlogDetailState();
}

class _MobileBlogDetailState extends State<MobileBlogDetail> {
